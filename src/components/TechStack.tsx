...
import { Layers, Terminal, Database, Brain, Cloud } from "lucide-react";
  ...
  const categories = [
    {
      ...
      icon: Brain,
      skills: ["Generative AI", "Agentic AI", "AI Agents", "Agent Workflows", "Google Gemini AI", "GPT-4o / GPT-4o-mini", "Prompt Engineering"],
    },
    {
      title: "Languages",
      icon: Terminal,
    ...
    },
    {
      ...
      icon: Layers,
      skills: ["React", "Node.js", "Express.js", "Tailwind CSS", "Django"],
    },
    {
      title: "Databases",
      icon: Database,
      skills: ["Firebase (Firestore)", "MongoDB", "MongoDB Atlas"],
    },
    {
      title: "Tools & Platforms",
      icon: Cloud,
      skills: ["Git", "GitHub", "Render", "Netlify", "Vite", "Software Engineering"],
    },
  ];
